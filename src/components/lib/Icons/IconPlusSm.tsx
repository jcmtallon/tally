...
interface IconPlusSmProps extends React.SVGProps<SVGSVGElement> {
  title?: string
}

function IconPlusSm(props: IconPlusSmProps) {
  return (
    <svg
      fill="currentColor"
      strokeWidth="0"
